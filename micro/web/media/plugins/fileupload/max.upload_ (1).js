    ...
    maxupload.prototype.init = function(){
      _html = '<div id="holder" class="preview" style="overflow:hidden;height:'+this.maxHeight+'px;width:'+this.maxWidth+'px;position:relative;border: 1px solid #D2D6DE;z-index: 2;">'+
                ...
                '<a href="javascript:void(0)" style="height:'+this.maxHeight+'px;width:'+this.maxWidth+'px;">'+
                  '<img parse_params="1" alt="upload-foto.png" src="'+this.photo+'" style="height:'+this.maxHeight+'px;width:'+this.maxWidth+'px;">'+
                  '<span id="edit" class="glyphicon glyphicon-edit btn-foto floatDivRight" style="display:none;"></span>'+
                '</a>'+
                '<div id="edit-tools" style="display:none;">'+
                  '<div id="left-tools" style="position:absolute;z-index:200;width: 64px;">'+
                    '<span id="zoom-in" class="glyphicon glyphicon-zoom-in btn-foto"></span>'+
                    '<span id="zoom-out" class="glyphicon glyphicon-zoom-out btn-foto"></span>'+
                  '</div>'+
                  '<div id="top-tools" style="position:absolute;z-index:200;">'+
                    '<span id="delete" class="glyphicon glyphicon-remove btn-foto"></span>'+
              ...
              '<div id="warp_filename" style="height:'+this.maxHeight+'px;width:'+this.maxWidth+'px;overflow:hidden;position: relative;top: '+(this.maxHeight*-1)+'px;cursor:pointer;">'+
                '<input disabled="disabled" id="'+this.filenameid+'" type="file" name="'+this.filenameid+'" style="top: 0px; left: -2000px;font-size: 245px; opacity: 0; filter:alpha(opacity: 0); margin: 0px;position: relative;cursor:pointer">'+
              '</div>'
